...
2. Confirm the bundle identifier, minimum macOS target, Sparkle dependency
   pin, SwanSong SDK 0.4.0 commit/content lock, production feed URL, public
...
8. Inspect `dist/`: the universal ZIP, corresponding-source archive,
   ...
   The app payload gate separately reconstructs SDK 0.4.0 from its exact tagged
...
- content-verified SwanSong SDK 0.4.0 runtime, schema, recipes, Python package,
