...
Story Forge and Studio are included in SwanSong 0.6.0 with the verified SDK
...
SwanSong 0.6.0 is pinned to released SDK 0.5.0 and exposes its public contracts
