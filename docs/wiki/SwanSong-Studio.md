...
Story Forge and Studio are included in SwanSong 0.7.2 with the verified SDK
...
SwanSong 0.7.2 is pinned to released SDK 0.5.0 and exposes its public contracts
