...
Story Forge and Studio are included in current releases with the verified SDK
...
Current SwanSong releases are pinned to SDK 0.5.0 and expose its public contracts
