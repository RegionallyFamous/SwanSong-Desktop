...
| Yokoi hardware utilities | Yokoi Boot and Yokoi Cart Service with the deterministic corresponding-source toolkit recorded in [`SOURCE_PROVENANCE.md`](https://github.com/RegionallyFamous/SwanSong-Desktop/blob/main/SOURCE_PROVENANCE.md) | Separately executable GPLv3 WonderSwan programs used by Cartridge Tools. Their payloads, license, notice, and preferred-form source are verified independently from the GPLv2 Mac executable. |
