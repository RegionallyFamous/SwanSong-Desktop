...
Release in one native workspace backed by SwanSong SDK. SwanSong 0.7.1 carries
...
The current public **0.7.1 release** makes SwanSong safer without making play
