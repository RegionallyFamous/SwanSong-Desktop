...
The current public download is **SwanSong 0.7.2**. It includes the complete SDK
...
SwanSong 0.7.2 includes the first-party Homebrew Catalog public key and can add
