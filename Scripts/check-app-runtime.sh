...
SWAN_ARES_ENGINE_DIR="$BUILD_DIR" \
"$MACOS_DIR/.build/debug/SwanSong" >"$BLOCKED_LOG_FILE" 2>&1 &
PID=$!
...
SWAN_SONG_QUICK_STATE_FRAME=20 \
SWAN_ARES_ENGINE_DIR="$BUILD_DIR" \
"$MACOS_DIR/.build/debug/SwanSong" >"$STRICT_GATE_LOG_FILE" 2>&1 &
PID=$!
...
SWAN_SONG_QUICK_STATE_FRAME=20 \
SWAN_ARES_ENGINE_DIR="$BUILD_DIR" \
"$MACOS_DIR/.build/debug/SwanSong" >"$PCV2_GATE_LOG_FILE" 2>&1 &
PID=$!
...
SWAN_SONG_QUICK_STATE_FRAME=20 \
SWAN_ARES_ENGINE_DIR="$BUILD_DIR" \
"$MACOS_DIR/.build/debug/SwanSong" >"$WRONG_KIND_LOG_FILE" 2>&1 &
PID=$!
...
SWAN_SONG_QUICK_STATE_FRAME=20 \
SWAN_ARES_ENGINE_DIR="$BUILD_DIR" \
"$MACOS_DIR/.build/debug/SwanSong" >"$RESUME_LOG_FILE" 2>&1 &
PID=$!
...
SWAN_SONG_QUICK_STATE_FRAME=20 \
SWAN_ARES_ENGINE_DIR="$BUILD_DIR" \
"$MACOS_DIR/.build/debug/SwanSong" >"$ZIP_RESUME_LOG_FILE" 2>&1 &
PID=$!
...
SWAN_ARES_ENGINE_DIR="$BUILD_DIR" \
"$MACOS_DIR/.build/debug/SwanSong" >"$PCV2_RESUME_LOG_FILE" 2>&1 &
PID=$!
...
SWAN_ARES_ENGINE_DIR="$BUILD_DIR" \
"$MACOS_DIR/.build/debug/SwanSong" >"$REWIND_LOG_FILE" 2>&1 &
PID=$!
